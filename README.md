...
Conclusion:
In this project we have used mobile and location services to develop an efficient and accurate attendance system. The functionality can be further improved with advanced functionalities like AI based validation or analytics.
